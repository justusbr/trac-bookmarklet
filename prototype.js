...
function run() {
    var headline = getHTMLInnerText($$("#stalker h1#summary-val")[0]);

    var idResult = headline.match(/§\d{4,5}/);
    
    if (idResult!=null) {
        var id = idResult[0].replace("§", "");

        window.location.href = "https://trac.neuland-bfi.de/bonprix/ticket/"+id;
    } else {
        var result = confirm("Create trac ticket?");
